...
class IdentificationTests {
    ...
    void getIdentificationFromEntryAndSpeciesId() {
        ...
        species.setType(SpeciesEntity.Type.Insect);
        species = speciesRepository.save(species);
        // create an entry
    ...
    private IdentificationEntity createIdentification(SpeciesEntity.Type type, String entryName, UserEntity user, String speciesName, boolean isValidated) {
        EntryEntity entry = null;
        if (type == SpeciesEntity.Type.Flower) {
            entry = new FlowerEntity();
        } else if (type == SpeciesEntity.Type.Insect) {
    ...
    void getIdentificationsSuggestedByOneUser() {
        ...
        createIdentification(SpeciesEntity.Type.Flower, "item1", user, "species_flower1", true);
        createIdentification(SpeciesEntity.Type.Insect, "item2", user, "species_insect1", true);
        createIdentification(SpeciesEntity.Type.Flower, "item3", user, "species_flower2", false);
    ...
    void cannotGiveValidatorRightsForTwoValidatedIdentifications() throws DataNotFoundException {
        ...
        createIdentification(SpeciesEntity.Type.Flower, "element1", entity, "flower1", true);
        createIdentification(SpeciesEntity.Type.Insect, "element2", entity, "insect1", true);
        createIdentification(SpeciesEntity.Type.Flower, "element3", entity, "flower2", true);
        createIdentification(SpeciesEntity.Type.Flower, "element4", entity, "flower3", false);
    ...
    void giveValidatorRightsForThreeFlowerValidatedIdentifications() throws DataNotFoundException {
        ...
        createIdentification(SpeciesEntity.Type.Flower, "el1", entity, "plant1", true);
        createIdentification(SpeciesEntity.Type.Flower, "el2", entity, "plant2", true);
        createIdentification(SpeciesEntity.Type.Flower, "el3", entity, "plant3", true);
    ...
    void createAndCommentIdentification() throws DataNotFoundException {
        ...
        IdentificationEntity created = createIdentification(SpeciesEntity.Type.Flower, "red_flower", user, "Rosaceae", false);
    ...
    void likeIdentification() throws DataNotFoundException {
        ...
        IdentificationEntity created = createIdentification(SpeciesEntity.Type.Flower, "blue_flower", user, "Cyanus segetum", false);
        Long speciesId = created.getSpecies().getId();
        Long entryId = created.getEntry().getId();
    ...
    void dislikeIdentification() throws DataNotFoundException {
        ...
        IdentificationEntity created = createIdentification(SpeciesEntity.Type.Flower, "white_flower", user, "Orchidaceae", false);
        Long speciesId = created.getSpecies().getId();
        Long entryId = created.getEntry().getId();
