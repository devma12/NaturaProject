...
INSERT INTO db_natura.entry (name, discriminator, user_id, validated) 
	SELECT * FROM (SELECT 'butterfly', 'Insect', (SELECT id FROM db_natura.user WHERE username='marion'), false) AS tmp
...
INSERT INTO db_natura.species (common_name, scientific_name, type, family, classification_order, validated) 
	VALUES ('Citron', 'Gonepteryx rhamni', 'Insect', 'Pieridae', 'Lepidoptera', true)
